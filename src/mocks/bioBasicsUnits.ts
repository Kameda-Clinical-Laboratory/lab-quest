        ...
        questions: [
          {
            ...
            choices: [
              { label: '臓器の働きや代謝の状態', correct: true },
              { label: '骨の形態', correct: false },
              { label: '皮膚の色調のみ', correct: false },
              { label: '視力', correct: false },
            ],
          ...
          },
          {
            ...
            choices: [
              { label: '受付・適正・投入', correct: true },
              { label: '日次報告のみ', correct: false },
              { label: '部屋の塗装', correct: false },
              { label: '食事当番', correct: false },
            ],
          ...
          },
          {
            ...
            choices: [
              { label: '施設手順に沿って速やかに連絡', correct: true },
              { label: 'SNSに投稿', correct: false },
              { label: '翌日まで待つ', correct: false },
              { label: '自分で診断する', correct: false },
            ],
        ...
        questions: [
          {
            ...
            prompt: '基準値の正しい理解は？',
            choices: [
              { label: '健常分布の目安で絶対基準ではない', correct: true },
              { label: '常に診断を確定する', correct: false },
              { label: '装置のエラーコード', correct: false },
              { label: '受付番号', correct: false },
            ],
