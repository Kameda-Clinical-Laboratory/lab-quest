    ...
    beats: [
      {
        ...
        lines: [
          ...
          { speaker: 'Ns.', text: 'ルーチンの姉害はしない範囲でお願いします。' },
        ],
      },
      {
        type: 'lecture',
      ...
      },
      {
        ...
        howTo: '教科書・配布資料で受付・適正・投入の順番を確認する。',
        inputPrompt: '基本流れを表すキーワード（例: 受付）',
        acceptedAnswers: ['受付', 'reception', 'accept'],
      ...
      },
      {
        ...
        inputPrompt: '視察したら「視察済」と入力',
        acceptedAnswers: ['視察済', '済', 'ok', 'done'],
        clueId: 'clue-priority-flow',
        manners: 'ルーチン姉害禁止・不要な声かけ禁止・目安5分以内',
        demoHint: 'モック: 視察済',
        xp: 5,
      },
      {
        ...
        steps: [
          {
            ...
            choices: [
              ...
              { label: 'まず分析製置の細かい設定から', correct: false, feedback: '今の溜まりに対しては受付側が先行です。' },
              { label: '全部後回しにして見学だけする', correct: false, feedback: '今の依頼には応えが必要です。' },
            ],
          },
          {
            id: 'bio-basics-u1-res-2',
            prompt: 'Ns. 「急ぎ依頼が添あったら？」',
            choices: [
  ...
  },
  {
    ...
    beats: [
      ...
      },
      {
        ...
        inputPrompt: 'キーワードを入力',
        acceptedAnswers: ['パニック値', 'パニック', 'panic', 'critical'],
        ...
        questions: [
          {
            ...
            format: 'mcq',
            prompt: '基準値の正しい理解は？',
            choices: ['健常分布の目安で絶対基準ではない', '常に診断を確定する', '製置のエラーコード', '受付番号'],
            correctIndex: 0,
