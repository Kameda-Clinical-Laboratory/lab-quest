...
export const JP = {
  ...
  consentNotYet: '未同意',
  consentReset: 'リセット',
  consentResetConfirm: '同意を取り消して、次回ログイン時に同意画面を再表示しますか？',
  consentResetOk: '同意をリセットしました',
  comma: '、',
  dash: '—',
  notTaken: '未受験',
  ...
  beatEditor: '幕編集',
  beatTitle: '幕のタイトル',
  beatTitlePlaceholder: '例: 看護師さんとの会話',
  addBeat: '幕を追加',
  deleteBeat: '削除',
  deleteBeatConfirm: 'この幕を削除しますか？',
  saveDraft: '下書き保存',
  ...
  unsavedConfirm: '保存されていない変更があります。保存せずに移動しますか？',
  ...
  lecturePdf: 'PDF',
  lecturePdfAdd: 'PDFを追加',
  lecturePdfReplace: 'PDFを差し替え',
  lecturePdfRemove: '削除',
  lecturePdfUploading: 'アップロード中…',
  lecturePdfNone: '添付なし',
  lectureVideo: '動画URL',
  lectureVideoHint: 'YouTube等の埋め込み可能なURLを貼り付けてください',
  problemFormHint:
  ...
  investigateRequired: '必須（未達成だとクエスト未クリア）',
  investigateManners: 'マナー（任意）',
  investigateDemoHint: 'ヒント（任意）',
  resolveRequiredClues: '必要な手がかり',
  resolveRequiredCluesHint:
    '複数の解決幕を連続で並べる場合、通し番号の最初の幕にだけ設定すれば十分です(入口を一度せき止めれば、以降の幕は既に通過済みのため)。',
